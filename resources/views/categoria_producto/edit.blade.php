    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            <div class="flex-grow-1">
                <h1 class="h3 fw-bold mb-1">Editar Categoria</h1>
            </div>
            <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-alt">
                    ...
                    <li class="breadcrumb-item">
                        <a class="link-fx" href="{{ route('categorias.index') }}">Categorias</a>
                    </li>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="interes" id="interes" class="form-control" value="{{ old('interes', $categoria->interes) }}" step="0.01" min="0" max="100" required>
            @error('interes')
            <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
