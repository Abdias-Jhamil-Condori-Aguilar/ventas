        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center py-2">
            ...
            <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-alt">
                    ...
                    <li class="breadcrumb-item">
                        <a class="link-fx" href="{{ route('clientes.show', $cliente->id) }}">Detalles</a>
                    </li>
                ...
                <div class="block-content block-content-full">
                    <form action="{{ route('clientes.update', $cliente->id) }}" method="post" id="clienteForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nombre" id="nombre" class="form-control" value="{{ old('nombre', $cliente->nombre) }}" placeholder="Nombre(s) del cliente" onkeypress="return soloLetras(event)">
                            @error('nombre')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="papellido" id="papellido" class="form-control" value="{{ old('papellido', $cliente->papellido) }}" placeholder="Apellido Paterno" onkeypress="return soloLetras(event)">
                            @error('apellido paterno')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            <label for="sapellido" class="form-label">Apellido Materno</label>
                            <input type="text" name="sapellido" id="sapellido" class="form-control" value="{{ old('sapellido', $cliente->sapellido) }}" placeholder="Apellido Materno" onkeypress="return soloLetras(event)">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="correo_electronico" id="correo_electronico" class="form-control" value="{{ old('correo_electronico', $cliente->correo_electronico) }}" placeholder="correo@ejemplo.com">
                        </div>
                        <div class="mb-3">
                            <label for="telefono" class="form-label">Teléfono</label>
                            <input type="tel" name="telefono" id="telefono" class="form-control" value="{{ old('telefono', $cliente->telefono) }}" placeholder="+591 00000000">
                            @error('telefono')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="domicilio" id="domicilio" class="form-control" value="{{ old('domicilio', $cliente->domicilio) }}" placeholder="Calle, número, colonia">
                            @error('domicilio')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select data-size="4" title="Seleccione una identificación" data-live-search="true" name="tipo_documento_id" id="tipo_documento_id" class="form-control selectpicker show-tick">
                                @foreach ($tipo_documentos as $item)
                                    <option value="{{ $item->id }}"{{ old('tipo_documento_id', $cliente->tipo_documento_id) == $item->id ? 'selected' : '' }}>{{ $item->nombre }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" name="numero_identificacion" id="numero_identificacion" value="{{ old('numero_identificacion', $cliente->numero_identificacion) }}" class="form-control" placeholder="Número de identificación" onkeypress="return soloNumeros(event)">
                        ...
                        <div class="mb-3" id="complementoField" style="display:none;">
                            ...
                            <input type="text" name="complemento" id="complemento" class="form-control" value="{{ old('complemento', $cliente->complemento) }}" placeholder="Ingrese el complemento">
                            @error('complemento')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
