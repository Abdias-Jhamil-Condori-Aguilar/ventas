...
class StoreInteresRequest extends FormRequest
{
    ...
    {
        return [
            'nombre' => 'required|string|max:255|unique:interes,nombre',
            'interes' => 'required|numeric|min:0|max:100|unique:interes,interes', // Validación para el porcentaje de interés
        ];
    }
